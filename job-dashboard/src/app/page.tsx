      ...
      <AnimatePresence>
        {showScrollTop && (
          <motion.button
            ...
            exit={{ opacity: 0, y: 20 }}
            onClick={scrollToTop}
            className=" cursor-pointer fixed bottom-6.5 left-4 sm:left-auto sm:right-1/4 md:right-1/5 lg:right-1/4 lg:bottom-11 z-80 bg-amber-200 p-3 rounded-full shadow-lg lg:hover:scale-105 lg:active:scale-95 transition duration-150"
          >

    ...
    return (
        <>
            <motion.div layout variants={variants} ref={ref} className="relative overflow-y-visible h-auto min-h-100 mt-8 rounded-2xl bg-white shadow-[0_4px_12px_rgba(0,0,0,0.08)] lg:min-h-80">
                ...
                <div className="min-h-100 lg:min-h-80 flex flex-col">
                                ...
                                <tbody>
                                    {filteredJobs && sortedJobs.map((job, index) => (
                                        <tr key={`${job.id}-${index}`} onClick={() => {
                                            ...
                                            <td className="p-2 lg:p-4 font-medium">{job.title}</td>
                                            <td className="p-2 lg:p-4">{job.company}</td>
                                            <td className="p-2 lg:p-4">{job.location}</td>
                                            <td className="p-2 lg:p-4">{job.experience_level}</td>
                                    ...
                                    {filteredJobs.length === 0 && (
                                        <tr>
                                            <td className="p-4 lg:p-6 font-medium text-gray-500">
